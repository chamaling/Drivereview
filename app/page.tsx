...
export default function Page() {
  return (
    <div className="flex flex-col h-screen items-center justify-center">
      ...
      <main className="flex flex-col gap-4 flex-1 justify-center items-center mt-8 md:mt-0 px-2">
        ...
        <GoogleDriveButton />
      <ol className="mt-16 text-lg text-muted-foreground grid grid-cols-1 md:grid-cols-[repeat(3,minmax(150px,1fr))] items-center gap-x-16 *:flex *:items-center *:relative *:flex-col *:gap-y-4 *:text-center">
