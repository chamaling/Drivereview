  ...
  return (
    <div className="flex flex-col h-screen items-center justify-center">
      ...
      <main className="flex flex-col gap-4 flex-1 justify-center items-center mt-16 md:mt-0 px-2">
        ...
        <p className="text-center text-muted-foreground mb-8 text-xs md:text-lg">Drivereview analyzes your Google Drive usage and identifies opportunities to optimize your storage.</p>
        <GoogleDriveButton />
