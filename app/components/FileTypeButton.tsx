  ...
  return (
    <Checkbox
      ...
      render={(props) => (
        <Button
          {...props}
          className="flex size-16 flex-col items-center justify-center min-[420px]:size-24 data-checked:bg-primary! data-checked:text-primary-foreground data-checked:hover:text-primary-foreground/90"
          variant="outline"
        >
